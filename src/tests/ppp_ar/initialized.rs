...
fn static_ppp_ar() {
    ...
    let cfg = Config::default().with_navigation_method(Method::PPP_AR);
    ...
    .enumerate()
    {
        ...
        match status {
            Err(e) => panic!("Static PPP-AR process failed with invalid error: {}", e),
            Ok(pvt) => {
                ...
                info!(
                    "{} (static) ppp-ar (with preset) error: x={}m y={}m z={}",
