...
mod test {
    use crate::prelude::{
        Candidate, Carrier, Duration, Epoch, PhaseCombination, PhaseRange, PseudoRange,
        PseudoRangeCombination, SV,
    };
    #[test]
